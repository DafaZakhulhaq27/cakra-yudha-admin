...
import { getTimezoneDropdown } from '@/api/timezone'
...
export default function SelectTimezone(props: Props) {
  const {
    getValues,
    setValue,
    formState: { errors },
  ...
  return (
    <div>
      ...
      >
        Timezone {props.required && <span className="text-red-500">*</span>}
      </label>
      <AsyncSelect
